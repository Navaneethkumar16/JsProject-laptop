                    ...
                    <div>
                        <Row>
                            <Col md={3}>
                                <div className="card" style={{ width: '18rem', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }} >
                                    <div className="card-body">
                                        <h3 class="bg-primary text-white p-1 rounded text-center" >User Details </h3>
                            ...
                            <Col md={3}>
                                <div className="card" style={{ width: '18rem', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }}>
                                    <div className="card-body">
                                        <h3 class="bg-primary text-white p-1 rounded text-center">Rental Details </h3>
                            ...
                            <Col md={6}>
                                {/* <Container> */}
                                    ...
                                    style={{ height: 400 }}
                                >   <h3 class="bg-primary text-white p-1 rounded text-center" >Rented Laptops </h3>
                                    <AgGridReact
                                        rowData={commonData}
                                        columnDefs={colDefs}
